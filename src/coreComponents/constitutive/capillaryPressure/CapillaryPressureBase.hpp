...
public:
  ...
  arrayView3d< real64 const > phaseCapPressure() const { return m_phaseCapPressure.toViewConst(); }
  arrayView4d< real64 const > dPhaseCapPressure_dPhaseVolFraction() const { return m_dPhaseCapPressure_dPhaseVolFrac.toViewConst(); }
