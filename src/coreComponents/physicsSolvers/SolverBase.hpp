...
//  virtual void Registration( dataRepository::WrapperCollection& domain );
  ...
  arrayView1d< real64 const > getLocalRhs() const { return m_localRhs.toViewConst(); }
  ...
  arrayView1d< real64 const > getLocalSolution() const { return m_localSolution.toViewConst(); }
  ...
  arrayView1d< string const > targetRegionNames() const { return m_targetRegionNames.toViewConst(); }
