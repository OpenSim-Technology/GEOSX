...
public:
   ...
   */
  arrayView1d< localIndex > GetWellElements() { return m_wellElementIndex.toView(); }
   ...
   * @return list of well element index connected to each perforation
   */
  arrayView1d< localIndex const > GetWellElements() const { return m_wellElementIndex.toViewConst(); }
   ...
   */
  arrayView1d< R1Tensor > GetLocation() { return m_location.toView(); }
   ...
   * @return list of perforation locations
   */
  arrayView1d< R1Tensor const > GetLocation() const { return m_location.toViewConst(); }
   ...
   */
  arrayView1d< real64 const > GetWellTransmissibility() const { return m_wellTransmissibility.toViewConst(); }
   ...
   * @return list of perforation well indices
   */
  arrayView1d< real64 > GetWellTransmissibility() { return m_wellTransmissibility.toView(); }
