...
public:
  ...
  arrayView2d< real64 > dDensity_dPressure() { return m_dDensity_dPressure.toView(); }
  arrayView2d< real64 const > dDensity_dPressure() const { return m_dDensity_dPressure.toViewConst(); }
  ...
  arrayView2d< real64 > dViscosity_dPressure() { return m_dViscosity_dPressure.toView(); }
  arrayView2d< real64 const > dViscosity_dPressure() const { return m_dViscosity_dPressure.toViewConst(); }
