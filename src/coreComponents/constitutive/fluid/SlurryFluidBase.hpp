...
public:
  ...
  arrayView1d< real64 > KIndex() const { return m_Ks.toView(); }
  arrayView1d< real64 const > nIndex() const { return m_nIndices.toViewConst(); }

  arrayView2d< real64 > density() { return m_density.toView(); }
  arrayView2d< real64 const > density() const { return m_density.toViewConst(); }

  arrayView2d< real64 > dDensity_dPressure() { return m_dDens_dPres.toView(); }
  arrayView2d< real64 const > dDensity_dPressure() const { return m_dDens_dPres.toViewConst(); }

  arrayView2d< real64 > dDensity_dProppantConcentration() { return m_dDens_dProppantConc.toView(); }
  arrayView2d< real64 const > dDensity_dProppantConcentration() const { return m_dDens_dProppantConc.toViewConst(); }

  arrayView3d< real64 > dDensity_dComponentConcentration() { return m_dDens_dCompConc.toView(); }
  arrayView3d< real64 const > dDensity_dComponentConcentration() const { return m_dDens_dCompConc.toViewConst(); }

  arrayView2d< real64 > fluidDensity() { return m_fluidDensity.toView(); }
  arrayView2d< real64 const > fluidDensity() const { return m_fluidDensity.toViewConst(); }

  arrayView2d< real64 > dFluidDensity_dPressure() { return m_dFluidDens_dPres.toView(); }
  arrayView2d< real64 const > dFluidDensity_dPressure() const { return m_dFluidDens_dPres.toViewConst(); }

  arrayView3d< real64 > dFluidDensity_dComponentConcentration() { return m_dFluidDens_dCompConc.toView(); }
  arrayView3d< real64 const > dFluidDensity_dComponentConcentration() const { return m_dFluidDens_dCompConc.toViewConst(); }

  arrayView3d< real64 > componentDensity() { return m_componentDensity.toView(); }
  arrayView3d< real64 const > componentDensity() const { return m_componentDensity.toViewConst(); }

  arrayView3d< real64 > dComponentDensity_dPressure() { return m_dCompDens_dPres.toView(); }
  arrayView3d< real64 const > dComponentDensity_dPressure() const { return m_dCompDens_dPres.toViewConst(); }

  arrayView4d< real64 > dComponentDensity_dComponentConcentration() { return m_dCompDens_dCompConc.toView(); }
  arrayView4d< real64 const > dComponentDensity_dComponentConcentration() const { return m_dCompDens_dCompConc.toViewConst(); }

  arrayView2d< real64 > fluidViscosity(){ return m_fluidViscosity.toView(); }
  arrayView2d< real64 const > fluidViscosity() const { return m_fluidViscosity.toViewConst(); }

  arrayView2d< real64 > dFluidViscosity_dPressure() { return m_dFluidVisc_dPres.toView(); }
  arrayView2d< real64 const > dFluidViscosity_dPressure() const { return m_dFluidVisc_dPres.toViewConst(); }

  arrayView3d< real64 > dFluidViscosity_dComponentConcentration() { return m_dFluidVisc_dCompConc.toView(); }
  arrayView3d< real64 const > dFluidViscosity_dComponentConcentration() const { return m_dFluidVisc_dCompConc.toViewConst(); }

  arrayView2d< real64 > viscosity() { return m_viscosity.toView(); }
  arrayView2d< real64 const > viscosity() const { return m_viscosity.toViewConst(); }

  arrayView2d< real64 > dViscosity_dPressure() { return m_dVisc_dPres.toView(); }
  arrayView2d< real64 const > dViscosity_dPressure() const { return m_dVisc_dPres.toViewConst(); }

  arrayView2d< real64 > dViscosity_dProppantConcentration() { return m_dVisc_dProppantConc.toView(); }
  arrayView2d< real64 const > dViscosity_dProppantConcentration() const { return m_dVisc_dProppantConc.toViewConst(); }

  arrayView3d< real64 > dViscosity_dComponentConcentration() { return m_dVisc_dCompConc.toView(); }
  arrayView3d< real64 const > dViscosity_dComponentConcentration() const { return m_dVisc_dCompConc.toViewConst(); }
