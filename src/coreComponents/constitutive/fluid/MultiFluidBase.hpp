...
public:
   ...
   */
  arrayView1d< string const > componentNames() const { return m_componentNames.toViewConst(); }
   ...
   */
  arrayView1d< string const > phaseNames() const { return m_phaseNames.toViewConst(); }
  ...
  arrayView3d< real64 const > phaseFraction() const { return m_phaseFraction.toViewConst(); }
  arrayView3d< real64 const > dPhaseFraction_dPressure() const { return m_dPhaseFraction_dPressure.toViewConst(); }
  arrayView3d< real64 const > dPhaseFraction_dTemperature() const { return m_dPhaseFraction_dTemperature.toViewConst(); }
  arrayView4d< real64 const > dPhaseFraction_dGlobalCompFraction() const { return m_dPhaseFraction_dGlobalCompFraction.toViewConst(); }

  arrayView3d< real64 const > phaseDensity() const { return m_phaseDensity.toViewConst(); }
  arrayView3d< real64 const > dPhaseDensity_dPressure() const { return m_dPhaseDensity_dPressure.toViewConst(); }
  arrayView3d< real64 const > dPhaseDensity_dTemperature() const { return m_dPhaseDensity_dTemperature.toViewConst(); }
  arrayView4d< real64 const > dPhaseDensity_dGlobalCompFraction() const { return m_dPhaseDensity_dGlobalCompFraction.toViewConst(); }

  arrayView3d< real64 const > phaseViscosity() const { return m_phaseViscosity.toViewConst(); }
  arrayView3d< real64 const > dPhaseViscosity_dPressure() const { return m_dPhaseViscosity_dPressure.toViewConst(); }
  arrayView3d< real64 const > dPhaseViscosity_dTemperature() const { return m_dPhaseViscosity_dTemperature.toViewConst(); }
  arrayView4d< real64 const > dPhaseViscosity_dGlobalCompFraction() const { return m_dPhaseViscosity_dGlobalCompFraction.toViewConst(); }

  arrayView4d< real64 const > phaseCompFraction() const { return m_phaseCompFraction.toViewConst(); }
  arrayView4d< real64 const > dPhaseCompFraction_dPressure() const { return m_dPhaseCompFraction_dPressure.toViewConst(); }
  arrayView4d< real64 const > dPhaseCompFraction_dTemperature() const { return m_dPhaseCompFraction_dTemperature.toViewConst(); }
  arrayView5d< real64 const > dPhaseCompFraction_dGlobalCompFraction() const { return m_dPhaseCompFraction_dGlobalCompFraction.toViewConst(); }

  arrayView2d< real64 const > totalDensity() const { return m_totalDensity.toViewConst(); }
  arrayView2d< real64 const > dTotalDensity_dPressure() const { return m_dTotalDensity_dPressure.toViewConst(); }
  arrayView2d< real64 const > dTotalDensity_dTemperature() const { return m_dTotalDensity_dTemperature.toViewConst(); }
  arrayView3d< real64 const > dTotalDensity_dGlobalCompFraction() const { return m_dTotalDensity_dGlobalCompFraction.toViewConst(); }
