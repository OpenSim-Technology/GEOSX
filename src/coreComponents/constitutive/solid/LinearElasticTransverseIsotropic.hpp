...
public:
   ...
   */
  arrayView1d< real64 const > getC11() const { return m_c11.toViewConst(); }
   ...
   */
  arrayView1d< real64 > getC11() { return m_c11.toView(); }
   ...
   */
  arrayView1d< real64 const > getC13() const { return m_c13.toViewConst(); }
   ...
   */
  arrayView1d< real64 > getC13() { return m_c13.toView(); }
   ...
   */
  arrayView1d< real64 const > getC33() const { return m_c33.toViewConst(); }
   ...
   */
  arrayView1d< real64 > getC33() { return m_c33.toView(); }
   ...
   */
  arrayView1d< real64 const > getC44() const { return m_c44.toViewConst(); }
   ...
   */
  arrayView1d< real64 > getC44() { return m_c44.toView(); }
   ...
   */
  arrayView1d< real64 const > getC66() const { return m_c66.toViewConst(); }
   ...
   */
  arrayView1d< real64 > getC66() { return m_c66.toView(); }
  ...
  {
    return LinearElasticTransverseIsotropicUpdates( m_c11.toViewConst(),
                                                    m_c13.toViewConst(),
                                                    m_c33.toViewConst(),
                                                    m_c44.toViewConst(),
                                                    m_c66.toViewConst(),
