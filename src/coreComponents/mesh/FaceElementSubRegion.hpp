...
public:
   ...
   */
  arrayView3d< real64 > getElementRotationMatrix()       { return m_elementRotationMatrix.toView(); }

  /**
   * @copydoc getElementRotationMatrix()
   */
  arrayView3d< real64 const > getElementRotationMatrix() const { return m_elementRotationMatrix.toViewConst(); }
   ...
   */
  arrayView1d< real64 > getSeparationCoefficient()       { return m_separationCoefficient.toView(); }
  /**
   * @copydoc getSeparationCoefficient()
   */
  arrayView1d< real64 const > getSeparationCoefficient() const { return m_separationCoefficient.toViewConst(); }
#endif
  ...
  { return m_dNdX.toViewConst().toViewConst(); }
