...
//START_SPHINX_INCLUDE_01
  ...
  arrayView1d< string const > relPermModelNames() const { return m_relPermModelNames.toViewConst(); }

  arrayView1d< string const > capPresModelNames() const { return m_capPressureModelNames.toViewConst(); }
