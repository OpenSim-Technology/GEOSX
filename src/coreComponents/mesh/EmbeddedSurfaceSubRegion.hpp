...
public:
   ...
   */
  arrayView1d< localIndex > getSurfaceToRegionList() { return m_embeddedSurfaceToRegion.toView(); }

  /**
   * @copydoc getSurfaceToRegionList()
   */
  arrayView1d< localIndex const > getSurfaceToRegionList() const { return m_embeddedSurfaceToRegion.toViewConst(); }
   ...
   */
  arrayView1d< localIndex > getSurfaceToSubRegionList() { return m_embeddedSurfaceToSubRegion.toView(); }

  /**
   * @copydoc getSurfaceToSubRegionList()
   */
  arrayView1d< localIndex const > getSurfaceToSubRegionList() const { return m_embeddedSurfaceToSubRegion.toViewConst(); }

  /**
   * @brief Get the embedded surface element to cell element map
   * @return the embedded surface element to cell element map
   */
  arrayView1d< localIndex > getSurfaceToCellList() { return m_embeddedSurfaceToCell.toView(); }

  /**
   * @copydoc getSurfaceToCellList()
   */
  arrayView1d< localIndex const > getSurfaceToCellList() const { return m_embeddedSurfaceToCell.toViewConst(); }
  ///@}
   ...
   */
  arrayView1d< real64 > getElementAperture() { return m_elementAperture.toView(); }

  /**
   * @copydoc getElementAperture()
   */
  arrayView1d< real64 const > getElementAperture() const { return m_elementAperture.toViewConst(); }

  /**
   * @brief Get the embedded surface elements surface area.
   * @return the surface area of the embedded surface elements
   */
  arrayView1d< real64 > getElementArea() { return m_elementArea.toView(); }

  /**
   * @copydoc getElementArea()
   */
  arrayView1d< real64 const > getElementArea() const { return m_elementArea.toViewConst(); }
   ...
   */
  arrayView1d< R1Tensor const > getNormalVector() const { return m_normalVector.toViewConst(); }
   ...
   */
  arrayView1d< R1Tensor const > getTangentVector1() const { return m_tangentVector1.toViewConst(); }
   ...
   */
  arrayView1d< R1Tensor const > getTangentVector2() const { return m_tangentVector2.toViewConst(); }
