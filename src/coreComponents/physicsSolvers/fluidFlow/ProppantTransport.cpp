...
void ProppantTransport::InitializePreSubGroups( Group * const rootGroup )
{
  ...
  for( auto & mesh : domain->getMeshBodies()->GetSubGroups() )
  {
    ...
    ValidateModelMapping< ParticleFluidBase >( *meshLevel.getElemManager(), m_proppantModelNames.toViewConst() );
  }
...
void ProppantTransport::UpdateFluidModel( Group & dataGroup, localIndex const targetIndex )
{
  ...
  arrayView2d< real64 const > const componentConc  = dataGroup.getReference< array2d< real64 > >( viewKeyStruct::componentConcentrationString ).toViewConst();
  arrayView2d< real64 const > const dComponentConc = dataGroup.getReference< array2d< real64 > >( viewKeyStruct::deltaComponentConcentrationString ).toViewConst();
...
void ProppantTransport::UpdateProppantModel( Group & dataGroup, localIndex const targetIndex )
{
  ...
  arrayView1d< real64 const > const proppantConc  = dataGroup.getReference< array1d< real64 > >( viewKeyStruct::proppantConcentrationString ).toViewConst();
  arrayView1d< real64 const > const dProppantConc = dataGroup.getReference< array1d< real64 > >( viewKeyStruct::deltaProppantConcentrationString ).toViewConst();
...
void ProppantTransport::UpdateProppantMobility( Group & dataGroup )
{
  ...
  arrayView1d< real64 const > const conc = dataGroup.getReference< array1d< real64 > >( viewKeyStruct::proppantConcentrationString ).toViewConst();
  arrayView1d< real64 const > const aperture = dataGroup.getReference< array1d< real64 > >( FaceElementSubRegion::viewKeyStruct::elementApertureString ).toViewConst();
                                              ...
                                              DomainPartition & domain )
{
  ...
  forTargetSubRegions( mesh, [&]( localIndex const, ElementSubRegionBase & subRegion )
  {
    ...
    arrayView1d< real64 const > const dProppantConc =
      subRegion.getReference< array1d< real64 > >( viewKeyStruct::deltaProppantConcentrationString ).toViewConst();
    ...
    arrayView2d< real64 const > const dComponentConc =
      subRegion.getReference< array2d< real64 > >( viewKeyStruct::deltaComponentConcentrationString ).toViewConst();
                                                   ...
                                                   arrayView1d< real64 > const & localRhs )
{
  ...
  forTargetSubRegions( mesh, [&]( localIndex const targetIndex, ElementSubRegionBase const & subRegion )
  {
    ...
    arrayView2d< real64 const > const componentDensOld =
      subRegion.getReference< array2d< real64 > >( viewKeyStruct::oldComponentDensityString ).toViewConst();
    arrayView1d< real64 const > const proppantConc =
      subRegion.getReference< array1d< real64 > >( viewKeyStruct::proppantConcentrationString ).toViewConst();
    arrayView1d< real64 const > const dProppantConc =
      subRegion.getReference< array1d< real64 > >( viewKeyStruct::deltaProppantConcentrationString ).toViewConst();
    arrayView1d< real64 const > const proppantPackVf =
      subRegion.getReference< array1d< real64 > >( viewKeyStruct::proppantPackVolumeFractionString ).toViewConst();
    arrayView1d< real64 const > const proppantLiftFlux =
      subRegion.getReference< array1d< real64 > >( viewKeyStruct::proppantLiftFluxString ).toViewConst();
                                           ...
                                           arrayView1d< real64 > const & localRhs )
{
  ...
  FluxKernel::ElementViewConst< arrayView1d< R1Tensor const > > const & transTMultiplier  = m_transTMultiplier.toNestedViewConst();
                                                 ...
                                                 arrayView1d< real64 > const & localRhs )
{
                        ...
                        string const & )
  {
    ...
    proppantConc = subRegion->getReference< array1d< real64 > >( viewKeyStruct::proppantConcentrationString ).toViewConst();

    arrayView1d< real64 const > const
    dProppantConc = subRegion->getReference< array1d< real64 > >( viewKeyStruct::deltaProppantConcentrationString ).toViewConst();
  ...
  if( NC > 0 )
  {
                           ...
                           string const & )
    {
      arrayView1d< integer const > const ghostRank =
        subRegion->getReference< array1d< integer > >( ObjectManagerBase::viewKeyStruct::ghostRankString ).toViewConst();
      ...
      arrayView2d< real64 const > const compConc =
        subRegion->getReference< array2d< real64 > >( viewKeyStruct::componentConcentrationString ).toViewConst();
      arrayView2d< real64 const > const deltaCompConc =
        subRegion->getReference< array2d< real64 > >( viewKeyStruct::deltaComponentConcentrationString ).toViewConst();
      arrayView2d< real64 const > const bcCompConc =
        subRegion->getReference< array2d< real64 > >( viewKeyStruct::bcComponentConcentrationString ).toViewConst();
                                             ...
                                             DomainPartition & domain )
{
  ...
  FluxKernel::ElementView< arrayView1d< R1Tensor > > const & cellBasedFlux = cellBasedFluxAccessor.toNestedView();
                                                  ...
                                                  DomainPartition & domain )
{
  ...
  fluxApprox.forAllStencils( mesh, [&]( auto const & stencil )
  {
    ProppantPackVolumeKernel::LaunchProppantPackVolumeCalculation( stencil,
                                                                   ...
                                                                   proppantPackVf.toNestedView(),
                                                                   proppantExcessPackV.toNestedView(),
  ...
  forTargetSubRegions( mesh, [&]( localIndex const, ElementSubRegionBase & subRegion )
  {
    ...
    arrayView1d< real64 const > const aperture0 =
      subRegion.getReference< array1d< real64 > >( FaceElementSubRegion::viewKeyStruct::elementApertureString ).toViewConst();
