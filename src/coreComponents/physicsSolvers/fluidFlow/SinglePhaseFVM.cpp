                                                   ...
                                                   arrayView1d< real64 > const & localRhs )
{
  ...
  arrayView1d< real64 const > const presFace =
    faceManager.getReference< array1d< real64 > >( viewKeyStruct::facePressureString ).toViewConst();

  arrayView1d< real64 const > const gravCoefFace =
    faceManager.getReference< array1d< real64 > >( viewKeyStruct::gravityCoefString ).toViewConst();
