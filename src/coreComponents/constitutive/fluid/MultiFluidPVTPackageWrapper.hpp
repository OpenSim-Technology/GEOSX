...
public:
  ...
  KernelWrapper createKernelWrapper()
  {
    return KernelWrapper( *m_fluid,
                          ...
                          m_dPhaseFraction_dPressure.toView(),
                          m_dPhaseFraction_dTemperature.toView(),
                          m_dPhaseFraction_dGlobalCompFraction.toView(),
                          m_phaseDensity.toView(),
                          m_dPhaseDensity_dPressure.toView(),
                          m_dPhaseDensity_dTemperature.toView(),
                          m_dPhaseDensity_dGlobalCompFraction.toView(),
                          m_phaseViscosity.toView(),
                          m_dPhaseViscosity_dPressure.toView(),
                          m_dPhaseViscosity_dTemperature.toView(),
                          m_dPhaseViscosity_dGlobalCompFraction.toView(),
                          m_phaseCompFraction.toView(),
                          m_dPhaseCompFraction_dPressure.toView(),
                          m_dPhaseCompFraction_dTemperature.toView(),
                          m_dPhaseCompFraction_dGlobalCompFraction.toView(),
                          m_totalDensity.toView(),
                          m_dTotalDensity_dPressure.toView(),
                          m_dTotalDensity_dTemperature.toView(),
                          m_dTotalDensity_dGlobalCompFraction.toView() );
  }
