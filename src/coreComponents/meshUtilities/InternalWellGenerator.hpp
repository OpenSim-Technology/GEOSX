...
public:
   ...
   */
  arrayView1d< R1Tensor const > GetElemCoords() const { return m_elemCenterCoords.toViewConst(); }
   ...
   */
  arrayView1d< globalIndex const > GetNextElemIndex() const { return m_nextElemId.toViewConst(); }
   ...
   */
  arrayView2d< globalIndex const > GetElemToNodesMap() const { return m_elemToNodesMap.toViewConst(); }

  /**
   * @brief Get the volume of the well elements.
   * @return list of volumes of the well elements
   */
  arrayView1d< real64 const > GetElemVolume() const { return m_elemVolume.toViewConst(); }
   ...
   * @return list of center locations of the well elements
   */
  arrayView1d< R1Tensor const > GetNodeCoords() const { return m_nodeCoords.toViewConst(); }
   ...
   */
  arrayView1d< R1Tensor const > GetPerfCoords() const { return m_perfCoords.toViewConst(); }
   ...
   */
  arrayView1d< real64 const > GetPerfTransmissibility() const { return m_perfTransmissibility.toViewConst(); }
   ...
   */
  arrayView1d< globalIndex const > GetPerfElemIndex() const { return m_perfElemId.toViewConst(); }
