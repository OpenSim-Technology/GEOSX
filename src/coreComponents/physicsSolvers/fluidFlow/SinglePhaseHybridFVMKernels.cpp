                          ...
                          arrayView1d< real64 > const & localRhs )
{
  ...
  AssemblerKernelHelper::ComputeOneSidedVolFluxes< NF >( facePres,
                                                         ...
                                                         dElemDens_dp,
                                                         transMatrix,
                                                         oneSidedVolFlux.toSlice(),
                                                         dOneSidedVolFlux_dp.toSlice(),
                                                         dOneSidedVolFlux_dfp.toSlice() );
  ...
  if( elemGhostRank < 0 )
  {
    AssemblerKernelHelper::UpdateUpwindedCoefficients< NF >( er, esr, ei,
                                                             ...
                                                             dMobility_dp,
                                                             elemDofNumber,
                                                             oneSidedVolFlux.toSliceConst(),
                                                             upwMobility.toSlice(),
                                                             dUpwMobility_dp.toSlice(),
                                                             upwDofNumber.toSlice() );
  ...
  AssemblerKernelHelper::AssembleConstraints< NF >( faceDofNumber,
                                                    ...
                                                    rankOffset,
                                                    oneSidedVolFlux.toSliceConst(),
                                                    dOneSidedVolFlux_dp.toSliceConst(),
                                                    dOneSidedVolFlux_dfp.toSliceConst(),
                                                    localMatrix,
                                                    localRhs );
}
